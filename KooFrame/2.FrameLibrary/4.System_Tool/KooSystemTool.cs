...
namespace KooFrame.FrameTools
{
    public static class KooSystemTool
    {
        ...
        {
            return KooStringTool.IsNumberAndLetterStruct(inputStr);
        }
        ...
        {
            return KooStringTool.IsLowercaseLetterStruct(inputStr);
        }
        ...
        {
            return KooStringTool.IsUppercaseLetterStruct(inputStr);
        }
        ...
        {
            return KooColorTool.IsBas16ColorFormat(inputStr);
        }
