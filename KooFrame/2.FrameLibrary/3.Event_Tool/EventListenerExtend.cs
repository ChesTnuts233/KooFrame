...
namespace KooFrame
{
    public static class GameEventListenerExtend
    {
        ...
        public static void AddEventListener<T, TEventArg>(this Component com, GameEventType eventType, Action<T, TEventArg> action, TEventArg args = default(TEventArg))
        {
        ...
        public static void RemoveEventListener<T, TEventArg>(this Component com, GameEventType eventType, Action<T, TEventArg> action)
        {
