...
namespace KooFrame
{
    ...
    public class UILocalizationCollector : SerializedMonoBehaviour
    {
        ...
        private void OnDisable() { LocalizationSystem.UnregisterLanguageEvent(OnUpdateLanguage); }
        ...
        public void InitAnalyzer(Action<object, string> analyzer) { this.analyzer = analyzer; }
